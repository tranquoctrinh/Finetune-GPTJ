...
def main():
    ...
    # add tokens
    print(f"Length tokenizer before add special tokens: {len(tokenizer)}")
    tokenizer.add_tokens(["<language>","<envelope>","<back>","<front>","<rewrite>","<title>","<date>","<photographer>","<agency>", "<END>", "<b>"])
    # add special tokens
    # special_tokens_dict = {"additional_special_tokens": ["<END>", "<b>"]}
    # num_added_toks = tokenizer.add_special_tokens(special_tokens_dict)
    print("----------------- Embedding:", model.resize_token_embeddings(len(tokenizer)))
    print(f"----------------- Length tokenizer after add special tokens: {len(tokenizer)}")
